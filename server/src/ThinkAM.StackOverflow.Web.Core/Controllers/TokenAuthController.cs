...
using Abp.UI;
using ThinkAM.StackOverflow.Authentication.External;
...
using ThinkAM.StackOverflow.Models.TokenAuth;
using ThinkAM.StackOverflow.MultiTenancy;

namespace ThinkAM.StackOverflow.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : StackOverflowControllerBase
    {
