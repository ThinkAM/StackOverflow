...
namespace ThinkAM.StackOverflow.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = StackOverflowConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(StackOverflowDbContext context)
        {
            _context = context;
        }
